...
When tasked with generating documentation, pull request summaries, code explanations, refactoring reviews, or technical proposals, route directly to the corresponding category:

| Domain Need | Primary Category | Core Cognitive Focus |
|---|---|---|
...
## Reference Pointers
* Parent Monorepo Container: [kirby-skills-writers-collection](../../SKILL.md)
* Source Video Lecture Registry: [fitzpatrick_source_manifest.md](../docs/fitzpatrick_source_manifest.md)
* Monorepo Help & Index: [kirby-help](../../../kirby-help/SKILL.md)
